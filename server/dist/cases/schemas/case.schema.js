...
], Case.prototype, "employeeId", void 0);
__decorate([
    (0, mongoose_1.Prop)({ required: true, type: mongoose_2.Types.ObjectId, ref: 'User', index: true }),
    __metadata("design:type", mongoose_2.Types.ObjectId)
], Case.prototype, "orgId", void 0);
__decorate([
    (0, mongoose_1.Prop)({ required: true, type: mongoose_2.Types.ObjectId, ref: 'User' }),
    __metadata("design:type", mongoose_2.Types.ObjectId)
], Case.prototype, "flaggedBy", void 0);
__decorate([
    (0, mongoose_1.Prop)({ required: true, type: Date, default: Date.now }),
    __metadata("design:type", Date)
], Case.prototype, "flaggedAt", void 0);
__decorate([
    (0, mongoose_1.Prop)({
        type: String,
        enum: Object.values(enums_1.CaseStatus),
        default: enums_1.CaseStatus.OPEN,
    }),
...
], Case.prototype, "resolvedAt", void 0);
__decorate([
    (0, mongoose_1.Prop)({ type: mongoose_2.Types.ObjectId, ref: 'User', default: null }),
    __metadata("design:type", Object)
], Case.prototype, "resolvedBy", void 0);
__decorate([
    (0, mongoose_1.Prop)({ type: String, default: null }),
    __metadata("design:type", Object)
], Case.prototype, "notes", void 0);
exports.Case = Case = __decorate([
    (0, mongoose_1.Schema)({ timestamps: true, collection: 'cases' })
], Case);
exports.CaseSchema = mongoose_1.SchemaFactory.createForClass(Case);
exports.CaseSchema.index({ orgId: 1, status: 1 });
exports.CaseSchema.index({ employeeId: 1 }, { unique: true });
