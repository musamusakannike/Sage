...
__decorate([
    (0, mongoose_1.Prop)({ required: true, type: String, unique: true, lowercase: true }),
    __metadata("design:type", String)
...
__decorate([
    (0, mongoose_1.Prop)({ required: true, type: String, enum: Object.values(enums_1.UserRole) }),
    __metadata("design:type", String)
...
exports.UserSchema.index({ orgId: 1 });
